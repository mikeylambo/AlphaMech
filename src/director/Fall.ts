...
export const FALL_TIERS: FallTier[] = [
  ...
  { id: 5, name: 'FALL V', changes: 'ASYNC SEQUENCING UNLOCKED · FORWARD BIAS REACHES 0.48 · TWO EXTRA WAVES', ...base, tokenCooldown: 1.30, forwardBias: 0.48, arenaCeiling: 6, asyncAllowed: true, spawnSpread: 0.90, reinforcementScale: 0.70, waveBonus: 2, geometryPressure: 1.10 },
  { id: 6, name: 'FALL VI', changes: 'CEILING → 7 · THREE EXTRA WAVES · BEARINGS WIDENED', ...base, tokenCooldown: 1.26, forwardBias: 0.58, arenaCeiling: 7, asyncAllowed: true, spawnSpread: 1.05, reinforcementScale: 0.62, waveBonus: 3, geometryPressure: 1.15 },
  { id: 7, name: 'FALL VII', changes: 'ONE ELITE PER ENCOUNTER · CEILING → 8 · REINFORCEMENT PACING TIGHTENS AGAIN', ...base, tokenCooldown: 1.20, forwardBias: 0.68, arenaCeiling: 8, asyncAllowed: true, spawnSpread: 1.20, reinforcementScale: 0.56, waveBonus: 3, elites: 1, geometryPressure: 1.20 },
  { id: 8, name: 'FALL VIII', changes: 'CORRUPTED OFFERS REACH 50% · CEILING → 9 · FOUR EXTRA WAVES', ...base, tokenCooldown: 1.14, forwardBias: 0.76, arenaCeiling: 9, asyncAllowed: true, spawnSpread: 1.35, reinforcementScale: 0.52, waveBonus: 4, elites: 1, corruptedFraction: 0.5, geometryPressure: 1.30 },
  { id: 9, name: 'FALL IX', changes: 'TWO ELITES · FIVE EXTRA WAVES · REINFORCEMENT PACING HALVED', ...base, tokenCooldown: 1.08, forwardBias: 0.84, arenaCeiling: 9, asyncAllowed: true, spawnSpread: 1.50, reinforcementScale: 0.48, waveBonus: 5, elites: 2, corruptedFraction: 0.5, geometryPressure: 1.40 },
  { id: 10, name: 'FALL X', changes: 'TOKEN COOLDOWN → 1.00s · CORRUPTED-ONLY OFFERS · MAXIMUM COMPOSITIONS', ...base, tokenCooldown: 1.00, forwardBias: 0.92, arenaCeiling: 10, asyncAllowed: true, spawnSpread: 1.65, reinforcementScale: 0.44, waveBonus: 6, elites: 3, corruptedFraction: 1.0, geometryPressure: 1.5 },
];
